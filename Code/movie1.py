...
def rest_query_ex1():
    ...
    tweets = myApi.search(q="#GuardiansoftheGalaxyVol2", geocode=geo)
    for tweet in tweets:
        print   tweet.text
        observation = {"text": tweet.text}
        with open('guardians of the galaxy vol. 2.txt', 'a+') as f1:
...
def rest_query_ex2():
    ...
    for tweet in tweets:
        print  tweet.text
        observation = {"text": tweet.text}
        with open('#GuardiansoftheGalaxyVol2', 'a+') as f1:
            f1.write(json.dumps(str(observation)))
            f1.write("\n")
            f1.write("\n")
...
def rest_query_ex11():
    geo = '39.833851,-74.871826 ,10000mi' #NJ
    tweets = myApi.search(q="#GuardiansoftheGalaxyVol2", geocode=geo)
    for tweet in tweets:
        print  tweet.text
        observation = { "text": tweet.text}
...
def rest_query_ex12():
    geo = ' 51.5085300, -0.1257400 20000mi' #london
    tweets = myApi.search(q="#GuardiansoftheGalaxyVol2", geocode=geo)
    for tweet in tweets:
        print  tweet.text
        observation = { "text": tweet.text}
...
def rest_query_ex13():
    geo = ' 43.6525, -79.381667 20000mi' #torronto
    tweets = myApi.search(q="#GuardiansoftheGalaxyVol2", geocode=geo)
    for tweet in tweets:
        print  tweet.text
        observation = { "text": tweet.text}
...
def rest_query_ex14():
    geo = ' -6.21462, 106.84513 20000mi' #jakarta
    tweets = myApi.search(q="#GuardiansoftheGalaxyVol2", geocode=geo)
    for tweet in tweets:
        print  tweet.text
        observation = { "text": tweet.text}
...
def rest_query_ex15():
    geo = ' 2.349014, 48.864716 20000mi' #jakarta
    tweets = myApi.search(q="#GuardiansoftheGalaxyVol2", geocode=geo)
    for tweet in tweets:
        print  tweet.text
        observation = { "text": tweet.text}
